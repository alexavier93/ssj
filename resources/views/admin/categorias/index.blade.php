...
@section('content')
    ...
    <div class="page-header-content py-3">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
            ...
            <a href="{{ route('admin.categorias.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            ...
                            @foreach ($categorias as $categoria)
                                ...
                                <tr>
                                    ...
                                    <td width="15%">
                                        ...
                                        <a href="javascript:;" data-toggle="modal" data-id='{{ $categoria->id }}' data-target="#modalDelete" class="btn btn-sm btn-danger delete">Excluir</a>
                                    </td>
                                </tr>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('admin.categorias.delete') }}" method="post" class="float-right">
                        @csrf
