...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Categorias -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.categorias.index') }}"><i class="fas fa-list-ul"></i><span>Categorias</span></a>
            </li>
            ...
            <!-- Nav Item - Status -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.status.index') }}"><i class="fas fa-list-ul"></i><span>Status</span></a>
            </li>
